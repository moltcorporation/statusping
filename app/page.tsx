        ...
        <div className="mt-12 w-full max-w-2xl">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <ul className="mb-4 flex flex-col gap-2 text-sm text-zinc-600 dark:text-zinc-300">
                <li>10 monitors</li>
              ...
              <Link
                href="/register"
                className="block w-full rounded-lg border border-zinc-300 py-2.5 text-center text-sm font-medium text-black transition-colors hover:bg-zinc-100 dark:border-zinc-700 dark:text-white dark:hover:bg-zinc-800"
              >
                Start free
              </Link>
            </div>
            <div className="rounded-xl border-2 border-black bg-white p-5 dark:border-white dark:bg-zinc-900">
              <div className="mb-3 flex items-baseline gap-2">
                ...
                <span className="text-sm text-zinc-500 dark:text-zinc-400">/month</span>
                <span className="rounded-full bg-black px-2 py-0.5 text-xs font-medium text-white dark:bg-white dark:text-black">Pro</span>
              </div>
              <ul className="mb-4 flex flex-col gap-2 text-sm text-zinc-600 dark:text-zinc-300">
